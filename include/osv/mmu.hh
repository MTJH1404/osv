...
public:
    ...
    void set_buddy_ref(size_t ref, int count);
    ...
    bool splittable() const { return _buddy_count < 2; };
    class addr_compare;
protected:
    addr_range _range;
    unsigned _perm;
...
addr_range reserve_memory_region(void * _start, void * _end, bool search = true);
